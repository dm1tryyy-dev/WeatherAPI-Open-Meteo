...
ПРИМЕЧАНИЕ: Если пришло сообщение, что города не существует, то прервите процесс (CTRL-C), чтобы не ждать! Убедитесь, что город такой существует и написан правильно.
''')
			time.sleep(60) # можно закомментировать для быстрого ответа (по желанию)
